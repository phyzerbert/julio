                                ...
                                <table class="table table-bordered" id="product_table">
                                    ...
                                    <tbody class="top-search-form">
                                        <tr v-for="(item,i) in order_items" :key="i">
                                            ...
                                            <td><input type="text" class="form-control form-control-sm cost" name="cost[]" pattern="^[0-9]\d*(\.\d{0,2})?$" v-model="item.cost" required placeholder="{{__('page.product_cost')}}" /></td>
