...
@section('content')
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="pull-left page-title"><i class="fa fa-sitemap"></i> {{__('page.transaction_category')}}</h3>
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{route('home')}}">{{__('page.home')}}</a></li>
                        <li class="active">{{__('page.transaction_category')}}</li>
                    </ol>
                </div>
            </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="py-1">
                                        ...
                                        <a href="{{route('tcategory.delete', $item->id)}}" class="btn btn-sm btn-danger btn-icon btn-confirm" data-id="{{$item->id}}"><div><i class="fa fa-trash-o"></i></div></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal fade" id="addModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('tcategory.create')}}" id="create_form" method="post">
                    @csrf
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('tcategory.edit')}}" id="edit_form" method="post">
                    @csrf
